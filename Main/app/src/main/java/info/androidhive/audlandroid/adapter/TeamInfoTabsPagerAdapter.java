...
public class TeamInfoTabsPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int index) {
        ...
        case 0:
            ...
            scoresArgs.putString("TEAM_ABBREV", team.getTeamAbbrev());
            scoresArgs.putString("DIVISION_NAME", team.getDivision());
        ...
        case 1:
            ...
            schedArgs.putString("TEAM_ABBREV", team.getTeamAbbrev());
        ...
        case 2:
            ...
            statsArgs.putString("TEAM_ABBREV", team.getTeamAbbrev());
