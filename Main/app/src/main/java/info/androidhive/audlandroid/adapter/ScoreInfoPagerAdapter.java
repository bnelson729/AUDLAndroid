...
public class ScoreInfoPagerAdapter extends FragmentStatePagerAdapter{
	...
	public Fragment getItem(int index) {
		...
		case 0:
            ...
            args.putString("HOMETEAM", score.getHomeTeam());
            args.putString("AWAYTEAM", score.getAwayTeam());
            args.putString("GAMESTATUS", score.getGameStatus());
            args.putString("DIVISIONNAME", score.getDivision());
		...
		case 1:
            ...
            bundle.putString("HOMESCORE",score.getHomeTeamScore());
            bundle.putString("AWAYSCORE",score.getAwayTeamScore());
            bundle.putString("GAMESTATUS", score.getGameStatus());
