...
public class TeamsListItem {
	...
	public TeamsListItem(String name, String id, String abbrev){
		this.teamName = name;
        this.teamAbbrev=abbrev;
		this.teamId = id;
    ...
    public TeamsListItem(String name, String id, String abbrev, String division){
        this.teamName = name;
        this.teamAbbrev=abbrev;
        this.teamId = id;
